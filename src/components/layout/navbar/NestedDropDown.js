  ...
  return (
    ...
    {serviceLinks?.service_provider?.id && (
      ...
      { serviceLinks?.rent?.id && (
        ...
        <li className={style.nestedDropDownLi}> 
            <Link className={style.linkColor} to="/show-service" state={({ id: serviceLinks?.rent?.id })}>
                {t("Rent")}
              </Link>
        </li>
      )}
      {serviceLinks?.jobs?.id && (
        <li className={style.nestedDropDownLi}> 
            <Link className={style.linkColor} to="/show-service" state={({ id: serviceLinks?.jobs?.id })}>
                {t("Jobs")}
              </Link>
        </li>
      )}
